...
CREATE TABLE atendimento (
    -- [Etapa 2] id gerado pelo banco: a sp_registrar_atendimento_completo
    -- insere atendimentos e precisa do id de volta. BY DEFAULT (e nao ALWAYS)
    -- para continuar aceitando os INSERTs com id explicito do insert_dados.sql.
    id_atendimento INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    ...
    -- [Etapa 2] unidade onde o atendimento ocorreu. Sem ela a
    -- sp_calcular_tempo_medio_espera nao consegue agrupar a espera por unidade:
    -- na Etapa 1 a unica ligacao com UNIDADE era via ESCALA, que representa a
    -- grade semanal fixa e nao o atendimento concreto.
...
CREATE TABLE procedimento_realizado (
    ...
    -- [Etapa 2] instante em que o procedimento comecou a ser executado.
    -- Na Etapa 1 so existia tempo_real_minutos, que e DURACAO e nao permite
    -- calcular tempo de espera. E a base da sp_calcular_tempo_medio_espera.
